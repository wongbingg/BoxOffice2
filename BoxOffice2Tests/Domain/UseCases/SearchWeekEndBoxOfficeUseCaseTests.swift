//
//  SearchWeekEndBoxOfficeUseCaseTests.swift
//  BoxOffice2Tests
//
...
final class SearchWeekEndBoxOfficeUseCaseTests: XCTestCase {
    var movieRepository: MovieRepositoryMock!
    var sut: SearchWeekEndBoxOfficeUseCase!

    override func setUpWithError() throws {
        movieRepository = MovieRepositoryMock()
        sut = DefaultSearchWeekEndBoxOfficeUseCase(
    ...
    func test_UseCase를실행하면_repository의_fetchWeekEndMovies가호출되는지() {
        ...
        XCTAssertEqual(expectationCallCount,
                       movieRepository.fetchWeekEndMoviesCallCount)
    }
